...
function getDefaultComplaints() {
    return [
        { id: 'CID-100001', city: 'Nallasopara', category: 'Road Damage', description: 'Deep potholes on Station Road', status: 'resolved', date: '2026-03-15', lat: 19.4123, lng: 72.8225 },
        { id: 'CID-100002', city: 'Nallasopara', category: 'Water Supply', description: 'No water for 3 days', status: 'in-progress', date: '2026-03-20', lat: 19.4150, lng: 72.8280 },
        { id: 'CID-100003', city: 'Nallasopara', category: 'Garbage', description: 'Overflowing bins near market', status: 'received', date: '2026-04-01', lat: 19.4098, lng: 72.8190 },
        { id: 'CID-100004', city: 'Virar', category: 'Street Light', description: 'Dark stretch near railway colony', status: 'in-progress', date: '2026-04-01', lat: 19.4550, lng: 72.8120 },
        { id: 'CID-100005', city: 'Virar', category: 'Drainage', description: 'Sewage leak on main road', status: 'resolved', date: '2026-03-10', lat: 19.4600, lng: 72.8180 },
        { id: 'CID-100006', city: 'Vasai', category: 'Park Maintenance', description: 'Broken benches in central park', status: 'resolved', date: '2026-01-25', lat: 19.3578, lng: 72.8194 },
        { id: 'CID-100007', city: 'Vasai', category: 'Noise Pollution', description: 'Loudspeakers after 10 PM', status: 'received', date: '2026-04-02', lat: 19.3620, lng: 72.8250 },
        { id: 'CID-100008', city: 'Vasai', category: 'Public Transport', description: 'Irregular bus timings', status: 'resolved', date: '2026-02-18', lat: 19.3545, lng: 72.8120 }
    ];
}
...
function updateHomepage() {
    ...
    container.innerHTML = cities.map(city => {
        ...
        const pct = Math.min(stats.total * 25, 100);
        return `
            <div class="city-card">
...
function setupComplaintForm() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        const complaint = { id: newId, city, category, description, status: 'received', date: new Date().toISOString().split('T')[0], lat, lng };
        ...
        successDiv.innerHTML = `<i class="fas fa-check-circle"></i> Complaint filed!<br><strong>ID: ${newId}</strong><br>Use this to track on map.`;
        form.reset();
...
function ensureMap(complaint) {
    ...
    // Heatmap: all complaints in the same city
